...
public class KafkaConfig {
    ...
    public ProducerFactory<String, Object> producerFactory() {
        ...
        configMap.put(JsonDeserializer.TRUSTED_PACKAGES, "com.learn.dto");
    ...
    @Bean
    public ConcurrentKafkaListenerContainerFactory<String, Sample> kafkaListenerContainerFactory() {
        ConcurrentKafkaListenerContainerFactory<String, Sample> factory = new ConcurrentKafkaListenerContainerFactory<String, Sample>();
